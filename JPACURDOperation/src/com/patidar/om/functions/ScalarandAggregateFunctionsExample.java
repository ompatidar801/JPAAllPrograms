...
public class ScalarandAggregateFunctionsExample {
	...
	public static void main(String[] args) {
		...
		///AVG function
		Query query5 = entitymanager.createQuery("Select AVG(e.salary) from Employee e");
		Double avgSalary = (Double) query5.getSingleResult();
		System.out.println("***********AVG Employee Salary :" + avgSalary);	
		
		/*///COUNTALL function
		Query query6 = entitymanager.createQuery("Select COUNT(*) from Employee e");
		Long countAll = (Long) query6.getSingleResult();
		System.out.println("***********COUNTALL Employee :" + countAll);*/
